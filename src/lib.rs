// src/lib.rs
/*
 * Core library for GaslessTransaction
 */
...
#[derive(Debug)]
pub struct GaslessTransactionProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GaslessTransactionProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GaslessTransaction processing");
    
    let mut processor = GaslessTransactionProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GaslessTransactionProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GaslessTransactionProcessor::new(false);
